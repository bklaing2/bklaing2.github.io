...
let collegeCove = {
  ...
  details: <p>
    ...
    order to easily deploy to iOS and Android.<br /><br />
...
let research = {
  ...
  details: <p>
    ...
    performing algorithm in Java on an Android smartwatch.<br /><br />
...
let peerMentor = {
  ...
  details: <p>
    Mentored over 100 freshmen students through their transition from high school to college<br />
    Assisted the College of Engineering with over 10 events concerning representation and diversity<br />
    Led activities that developed freshmen students' physical, emotional and social growth<br />
  </p>,
  icon: <FaUsers />,
}
